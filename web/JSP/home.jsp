...
<div class="container" id="main">
    ...
    <div class="jumbotron">
        <h1 class="display-3">Welcome to OnlineSchool!</h1>
        <p class="lead">Pass the test below and join us in an multitude of quiz to improve and test your full-stack knowledge!</p>
        <hr class="my-4">
    </div>
        ...
        <div class="col-lg-10 offset-md-2 ">
            <div class="bs-component">
                <form action="checkQuiz" method="post">
                    <input type="text" hidden name="type" value="entry">
                    <fieldset>
